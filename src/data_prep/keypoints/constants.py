"""Shared constants for the SoccerNet keypoint data preparation pipelines."""
...
# Where the raw SoccerNet zips are downloaded to, and where the prepared
# calibration datasets are written. See data/calibration/README.md.
dataset_dir = PROJECT_ROOT / "data"
calibration_dir = dataset_dir / "calibration"

# The SoccerNet download password is under an NDA and cannot be committed.
# Set it here locally, or export SOCCERNET_PASSWORD before running the downloader.
soccernet_password = os.environ.get("SOCCERNET_PASSWORD", "<...>")
