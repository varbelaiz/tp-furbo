...
print("--- Preprocessing check (heatmaps) ---")
...
try:
    ...
    print("Download this image from the VM and open it locally to check that the heat points land where they should.")

except Exception as e:
    print(f"Error during the visual check: {e}")