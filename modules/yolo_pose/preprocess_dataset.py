...
def check_and_download():
    ...
    if not os.path.exists(BASE_INPUT_DIR):
        ...
        print("The zips are already downloaded.")
...
def process_pipeline_step(split_name):
    ...
    # 2. PROCESAR A YOLO
    print(f"   Processing images and labels for {split_name}...")
    ...
    for json_path in tqdm(json_files, desc=f"   Convertendo {split_name}"):
        try:
            ...
            # Only keep the frame when there are enough points for a homography (6 minimum)
